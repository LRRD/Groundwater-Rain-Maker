...
float errorMAGhigh = 28.6;                          //Magnitude of error considered to be high
float KPatMAGlow = 1.5;                             //KP value to be used at errorMAGlow
float KPatMAGhigh = 2.5;                           //KP value to be used at errorMAGhigh

//Limit variables
const uint16_t setmax = 60;                         //Max setpoint
...
void setup()
{
  ...
  cursorLine2();
  Serial1.print(F("Software v1.38.1"));
  delay(2500);
  clearLCD();
