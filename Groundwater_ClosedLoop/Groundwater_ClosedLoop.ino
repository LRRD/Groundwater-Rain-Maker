...
float errorMAGlow = 2.0;                            //Magnitude of error considered to be low
float errorMAGhigh = 40.0;                          //Magnitude of error considered to be high
float KPatMAGlow = 3.0;                             //KP value to be used at errorMAGlow
float KPatMAGhigh = 10.0;                           //KP value to be used at errorMAGhigh
